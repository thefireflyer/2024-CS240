...
use cs_240_library::data_structures::graphs::{weighted_graph::WeightedGraph, IGraph};
use egui::{ahash::HashMap, emath::TSTransform, Color32, Pos2, Stroke, Vec2};
                            ...
                            for adj in adj.get_adj(&node) {
                                painter.line_segment(
                                    [
                                        *graph
                                            .get(node)
                                            .expect("couldn't find node when rendering")
                                            + Vec2::new(20.0, 16.0),
                                        *graph
                                            .get(&adj)
                                            .expect("couldn't find other node when rendering")
                                            + Vec2::new(20.0, 16.0),
                                    ],
